...
If you use [Haystack](http://haystacksearch.org/) as your projects search engine,
...
The `subprocess` module's `subprocess.run` returns a `subprocess.CompletedProcess` object:
...
Adapted from [Sebastian Raschka's blog](http://sebastianraschka.com/Articles/2014_multiprocessing_intro.html)
...
Django Q2 is not optimized for distributed computing, but this example will give you an idea of what you can do with task [group](group.md).
...
!!! note
    If you have an example you want to share, please submit a pull request on [github](https://github.com/tinuvi/django-q2-full-of-juice/).
